...
def build_Ruri_Endfield_Uber_Face():
    ...
    v210 = g.inp('_FaceRight', True, (1.0, 0.0, 0.0))
    v211 = g.inp('_FaceRight_w', False, 0.0)
    v212 = g.vmath('CROSS_PRODUCT', v208, v210)
    v213 = g.inp('F1_BumpMap', True, (0.5, 0.5, 1.0))
    v214 = g.inp('F1_BumpMap_alpha', False, 1.0)
    v215 = g.sep(v213)
    v216 = g.math('MULTIPLY', v215[0], v214)
    ...
    v252 = g.mixv(v248, v246, v251)
    v253 = g.mixf(v248, v247, 1.0)
    v254 = g.group_named('RCE_GetObjectFlatDir', [('positionWS', v15)])
    v255 = g.inp('_UseSDFLightmap', False, 0.0)
    g.out_('F5_SDFMask_uv', v0, True)
    v256 = g.inp('F5_SDFMask', True, (0.0, 0.0, 0.0))
    v257 = g.inp('F5_SDFMask_alpha', False, 1.0)
    v258 = g.mixv(v255, (1, 1, 0), v256)
    v259 = g.mixf(v255, 0, v257)
    v260 = g.vmath('DOT_PRODUCT', v109, v210)
    v261 = g.vmath('DOT_PRODUCT', v109, v212)
    v262 = g.vmath('DOT_PRODUCT', v109, v208)
    v263 = g.comb(v260, v261, v262)
    v264 = g.vmath('DOT_PRODUCT', v263, v263)
    v265 = g.math('MAXIMUM', v264, 1.175494E-38)
    v266 = g.math('INVERSE_SQRT', v265, 0.0)
    v267 = g.bc(v266)
    v268 = g.vmath('MULTIPLY', v263, v267)
    v269 = g.sep(v268)
    v270 = g.math('MULTIPLY', v269[0], v269[0])
    v271 = g.math('MULTIPLY', v269[2], v269[2])
    v272 = g.math('ADD', v270, v271)
    v273 = g.math('INVERSE_SQRT', v272, 0.0)
    v274 = g.sep(v252)
    v275 = g.comb(v274[0], 6.103515625e-05, v274[2])
    v276 = g.vmath('NORMALIZE', v275)
    v277 = g.sep(v258)
    v278 = g.mixv(v277[1], v254[0], v276)
    v279 = g.vmath('NORMALIZE', v278)
    v280 = g.mixv(v255, v276, v279)
    v281 = g.math('MULTIPLY', v269[2], v273)
    v282 = g.math('ADD', v281, 0.5)
    v283 = g.clampn(v282)
    v284 = g.mixf(v277[1], v283, 1)
    v285 = g.math('MULTIPLY', v284, v277[0])
    v286 = g.mixf(v255, 1, v285)
    v287 = g.inp('_SkinRimOffScale', False, 0.5)
    v288 = g.inp('_FaceRimOffScale', False, 1.0)
    v289 = g.mixf(v277[2], v288, v287)
    v290 = g.mixf(v255, v287, v289)
    v291 = g.vmath('DOT_PRODUCT', v252, v102)
    v292 = g.clampn(v291)
    v293 = g.math('MULTIPLY', v292, 0.85)
    v294 = g.math('ADD', v293, 0.15)
    v295 = g.math('SUBTRACT', 1, v294)
    v296 = g.math('MULTIPLY', v295, v286)
    v297 = g.math('MULTIPLY', v296, v290)
    v298 = g.clampn(v297)
    v299 = g.inp('_SDFRimColor', True, (1.0, 1.0, 1.0))
    v300 = g.inp('_SDFRimColor_w', False, 1.0)
    v301 = g.bc(v298)
    v302 = g.vmath('MULTIPLY', v299, v301)
    v303 = g.math('SUBTRACT', 1, v298)
    v304 = g.bc(v303)
    v305 = g.vmath('ADD', v302, v304)
    v306 = g.vmath('MULTIPLY', v188, v305)
    v307 = g.math('MULTIPLY', v277[1], v125)
    v308 = g.mixf(v255, v125, v307)
    v309 = g.math('SUBTRACT', 1, v122)
    v310 = g.math('MULTIPLY', v309, v309)
    v311 = g.math('MAXIMUM', v310, 0.0078125)
    v312 = g.math('SUBTRACT', 1, v124)
    v313 = g.math('MULTIPLY', v312, 0.96)
    v314 = g.bc(v313)
    v315 = g.vmath('MULTIPLY', v314, v306)
    v316 = g.math('MULTIPLY', v308, 0.04)
    v317 = g.bc(v316)
    v318 = g.vmath('SUBTRACT', v306, v317)
    v319 = g.bc(v124)
    v320 = g.vmath('MULTIPLY', v319, v318)
    v321 = g.math('MULTIPLY', v308, 0.04)
    v322 = g.bc(v321)
    v323 = g.vmath('ADD', v320, v322)
    v324 = g.inp('_UseShadowLutTex', False, 0.0)
    v325 = g.sep(v188)
    v326 = g.math('MULTIPLY', v325[0], 12.92)
    v327 = g.math('POWER', v325[0], 0.4166667)
    v328 = g.math('MULTIPLY', 1.055, v327)
    v329 = g.math('SUBTRACT', v328, 0.055)
    v330 = g.math('LESS_THAN', v325[0], 0.0031308)
    v331 = g.math('SUBTRACT', 1.0, v330)
    v332 = g.mixf(v331, v326, v329)
    v333 = g.clampn(v332)
    v334 = g.math('MULTIPLY', v325[1], 12.92)
    v335 = g.math('POWER', v325[1], 0.4166667)
    v336 = g.math('MULTIPLY', 1.055, v335)
    v337 = g.math('SUBTRACT', v336, 0.055)
    v338 = g.math('LESS_THAN', v325[1], 0.0031308)
    v339 = g.math('SUBTRACT', 1.0, v338)
    v340 = g.mixf(v339, v334, v337)
    v341 = g.clampn(v340)
    v342 = g.math('MULTIPLY', v325[2], 12.92)
    v343 = g.math('POWER', v325[2], 0.4166667)
    v344 = g.math('MULTIPLY', 1.055, v343)
    v345 = g.math('SUBTRACT', v344, 0.055)
    v346 = g.math('LESS_THAN', v325[2], 0.0031308)
    v347 = g.math('SUBTRACT', 1.0, v346)
    v348 = g.mixf(v347, v342, v345)
    v349 = g.clampn(v348)
    v350 = g.math('MULTIPLY', v349, 31)
    v351 = g.math('FLOOR', v350, 0.0)
    v352 = g.math('MULTIPLY', v351, 0.03125)
    v353 = g.math('MULTIPLY', v333, 0.0302734375)
    v354 = g.math('ADD', v352, v353)
    v355 = g.math('ADD', v354, 0.00048828125)
    v356 = g.math('MULTIPLY', v341, 0.96875)
    v357 = g.math('ADD', v356, 0.015625)
    v358 = g.comb(v355, v357, 0.0)
    g.out_('F6_ShadowLutTex_uv', v358, True)
    v359 = g.inp('F6_ShadowLutTex', True, (1.0, 1.0, 1.0))
    v360 = g.inp('F6_ShadowLutTex_alpha', False, 1.0)
    v361 = g.math('ADD', v355, 0.03125)
    v362 = g.comb(v361, v357, 0.0)
    g.out_('F7_ShadowLutTex_uv', v362, True)
    v363 = g.inp('F7_ShadowLutTex', True, (1.0, 1.0, 1.0))
    v364 = g.inp('F7_ShadowLutTex_alpha', False, 1.0)
    v365 = g.math('MULTIPLY', v349, 31)
    v366 = g.math('SUBTRACT', v365, v351)
    v367 = g.mixv(v366, v359, v363)
    v368 = g.mixv(v324, (0.0, 0.0, 0.0), v367)
    v369 = g.mixf(v324, 0.0, 1.0)
    v370 = g.math('SUBTRACT', 1.0, v369)
    v371 = g.inp('_ShadowColorBrightness', False, 0.5)
    v372 = g.bc(v371)
    v373 = g.vmath('MULTIPLY', v188, v372)
    v374 = g.math('SUBTRACT', 1.0, v369)
    v375 = g.vmath('DOT_PRODUCT', v373, (0.2126729, 0.7151522, 0.072175))
    v376 = g.math('SUBTRACT', 1.0, v369)
    v377 = g.inp('_ShadowColorSaturation', False, 1.0)
    v378 = g.bc(v375)
    v379 = g.vmath('SUBTRACT', v373, v378)
    v380 = g.bc(v377)
    v381 = g.vmath('MULTIPLY', v380, v379)
    v382 = g.bc(v375)
    v383 = g.vmath('ADD', v381, v382)
    v384 = g.mixv(v376, v368, v383)
    v385 = g.mixf(v376, v369, 1.0)
    v386 = g.bc(v313)
    v387 = g.vmath('MULTIPLY', v386, v384)
    v388 = g.math('MINIMUM', v135, 1)
    v389 = g.sep(v131)
    v390 = g.sep(v110)
    v391 = g.inp('_CharacterParams4', True, (1.0, 1.0, 1.0))
    v392 = g.inp('_CharacterParams4_w', False, 1.0)
    v393 = g.sep(v391)
    v394 = g.math('SUBTRACT', v393[0], v389[0])
    v395 = g.math('MULTIPLY', v390[1], v394)
    v396 = g.math('ADD', v389[0], v395)
    v397 = g.comb(v396, 0.0, 0.0)
    v398 = g.math('SUBTRACT', v393[1], v389[1])
    v399 = g.math('MULTIPLY', v390[1], v398)
    v400 = g.math('ADD', v389[1], v399)
    v401 = g.sep(v397)
    v402 = g.comb(v401[0], v400, v401[2])
    v403 = g.math('SUBTRACT', v393[2], v389[2])
    v404 = g.math('MULTIPLY', v390[1], v403)
    v405 = g.math('ADD', v389[2], v404)
    v406 = g.sep(v402)
    v407 = g.comb(v406[0], v406[1], v405)
    v408 = g.vmath('DOT_PRODUCT', v140[0], v210)
    v409 = g.vmath('DOT_PRODUCT', v140[0], v208)
    v410 = g.math('MULTIPLY', v408, v408)
    v411 = g.math('ADD', v410, 3.725290298461914E-09)
    v412 = g.math('MULTIPLY', v409, v409)
    v413 = g.math('ADD', v411, v412)
    v414 = g.math('INVERSE_SQRT', v413, 0.0)
    v415 = g.math('MULTIPLY', v414, v409)
    v416 = g.math('MULTIPLY', v414, v408)
    v417 = g.math('GREATER_THAN', v416, 0)
    v418 = g.mixf(v417, 0, 1)
    v419 = g.math('SUBTRACT', 1, v154[0])
    v420 = g.math('SUBTRACT', v154[0], v419)
    v421 = g.math('MULTIPLY_ADD', v418, v420, v419)
    v422 = g.comb(v421, v154[1], 0.0)
    g.out_('F8_SDFLightmap_uv', v422, True)
    v423 = g.inp('F8_SDFLightmap', True, (0.0, 0.0, 0.0))
    v424 = g.inp('F8_SDFLightmap_alpha', False, 1.0)
    v425 = g.sep(v423)
    v426 = g.math('ADD', v425[0], v425[1])
    v427 = g.math('MULTIPLY', 2, v425[2])
    v428 = g.math('SUBTRACT', 1, v427)
    v429 = g.math('MULTIPLY', 2, v425[2])
    v430 = g.math('SUBTRACT', v429, 1)
    v431 = g.math('SUBTRACT', v430, v428)
    v432 = g.math('MULTIPLY_ADD', v418, v431, v428)
    v433 = g.math('ABSOLUTE', v432, 0.0)
    v434 = g.math('SUBTRACT', 1, v433)
    v435 = g.comb(v432, 6.103515625e-05, v434)
    v436 = g.vmath('NORMALIZE', v435)
    v437 = g.sep(v436)
    v438 = g.bc(v437[0])
    v439 = g.vmath('MULTIPLY', v438, v210)
    v440 = g.bc(v437[1])
    v441 = g.vmath('MULTIPLY', v440, v212)
    v442 = g.vmath('ADD', v439, v441)
    v443 = g.bc(v437[2])
    v444 = g.vmath('MULTIPLY', v443, v208)
    v445 = g.vmath('ADD', v442, v444)
    v446 = g.vmath('NORMALIZE', v445)
    v447 = g.mixv(v277[1], v446, v252)
    v448 = g.vmath('NORMALIZE', v447)
    v449 = g.math('MULTIPLY', v415, -1.0)
    v450 = g.clampn(v449)
    v451 = g.math('MULTIPLY', v142, v450)
    v452 = g.math('SUBTRACT', 1, v390[0])
    v453 = g.math('MULTIPLY', v451, v452)
    v454 = g.math('MULTIPLY', v415, v415)
    v455 = g.math('SUBTRACT', 1, v454)
    v456 = g.math('MULTIPLY', 0.5, v455)
    v457 = g.math('MULTIPLY', v453, v456)
    v458 = g.math('ADD', v415, v457)
    v459 = g.math('MULTIPLY', v458, 0.5)
    v460 = g.math('SUBTRACT', 0.5, v459)
    v461 = g.clampn(v460, 0.001, 0.999)
    v462 = g.math('MULTIPLY', v426, 0.5)
    v463 = g.math('MULTIPLY', 2, v461)
    v464 = g.math('SUBTRACT', v463, 1)
    v465 = g.math('MAXIMUM', v464, 0)
    v466 = g.math('SUBTRACT', v462, v465)
    v467 = g.math('MULTIPLY', 2, v461)
    v468 = g.math('MINIMUM', v467, 1)
    v469 = g.math('MULTIPLY', 2, v461)
    v470 = g.math('SUBTRACT', v469, 1)
    v471 = g.math('MAXIMUM', v470, 0)
    v472 = g.math('SUBTRACT', v468, v471)
    v473 = g.math('DIVIDE', v466, v472)
    v474 = g.clampn(v473)
    v475 = g.math('MULTIPLY', v474, v474)
    v476 = g.math('MULTIPLY', 2, v474)
    v477 = g.math('SUBTRACT', 3, v476)
    v478 = g.math('MULTIPLY', v475, v477)
    v479 = g.math('CEIL', v459, 0.0)
    v480 = g.math('MULTIPLY', v479, v459)
    v481 = g.math('ADD', v478, v480)
    v482 = g.math('ABSOLUTE', v481, 0.0)
    v483 = g.math('MULTIPLY', v482, 2)
    v484 = g.math('SUBTRACT', v483, 1)
    v485 = g.mixv(v255, v252, v448)
    v486 = g.mixf(v255, 0, v426)
    v487 = g.mixf(v255, 0, v484)
    v488 = g.vmath('DOT_PRODUCT', v252, v140[0])
    v489 = g.math('MULTIPLY', v137, v390[0])
    v490 = g.math('ADD', v489, v488)
    v491 = g.math('MULTIPLY', 1, -1.0)
    v492 = g.clampn(v490, v491, 1)
    v493 = g.math('MULTIPLY', v492, 0.5)
    v494 = g.math('ADD', v493, 0.5)
    v495 = g.mixf(v277[1], v487, v492)
    v496 = g.math('MULTIPLY', v495, 0.5)
    v497 = g.math('ADD', v496, 0.5)
    v498 = g.mixf(v255, v494, v497)
    v499 = g.inp('_UseDiffRampMap', False, 0.0)
    v500 = g.comb(v498, 0.5, 0.0)
    g.out_('F9_DiffRampMap_uv', v500, True)
    v501 = g.inp('F9_DiffRampMap', True, (1.0, 1.0, 1.0))
    v502 = g.inp('F9_DiffRampMap_alpha', False, 1.0)
    v503 = g.sep(v501)
    v504 = g.math('MAXIMUM', v503[1], v503[2])
    v505 = g.math('MAXIMUM', v503[0], v504)
    v506 = g.math('MINIMUM', v503[1], v503[2])
    v507 = g.math('MINIMUM', v503[0], v506)
    v508 = g.math('SUBTRACT', v505, v507)
    v509 = g.math('SUBTRACT', 1, v508)
    v510 = g.mixv(v499, (1, 1, 1), v501)
    v511 = g.mixf(v499, 1, v502)
    v512 = g.mixf(v499, 0, v508)
    v513 = g.mixf(v499, 1, v509)
    v514 = g.math('SUBTRACT', v388, 0)
    v515 = g.math('DIVIDE', v514, 1)
    v516 = g.clampn(v515)
    v517 = g.math('MULTIPLY', v516, v516)
    v518 = g.math('MULTIPLY', 2.0, v516)
    v519 = g.math('SUBTRACT', 3.0, v518)
    v520 = g.math('MULTIPLY', v517, v519)
    v521 = g.sep(v138)
    v522 = g.mixf(v521[2], v520, 1)
    v523 = g.mixf(v255, v522, 1)
    v524 = g.math('MINIMUM', v511, v100)
    v525 = g.math('MULTIPLY', v524, v523)
    v526 = g.math('ADD', v100, v511)
    v527 = g.clampn(v526)
    v528 = g.clampn(v116[0], 0, 1.5)
    v529 = g.inp('_CharacterParams0', True, (0.0, 0.9, 0.8))
    v530 = g.inp('_CharacterParams0_w', False, 0.8)
    v531 = g.sep(v529)
    v532 = g.bc(v531[2])
    v533 = g.vmath('MULTIPLY', v387, v532)
    v534 = g.inp('_CharacterParams3', True, (1.0, 0.78114647, 0.68490565))
    v535 = g.inp('_CharacterParams3_w', False, 0.0)
    v536 = g.inp('_CharacterParams6', True, (0.0, 1.0, 4.371139E-08))
    v537 = g.inp('_CharacterParams6_w', False, 0.0)
    v538 = g.inp('_CharacterParams7', True, (0.15, 1.5, 0.5))
    v539 = g.inp('_CharacterParams7_w', False, 0.0)
    v540 = g.group_named('RCE_ComputeNPRDiffuse', [('hemisphereN', v280), ('ambCol', v534), ('brightness', v528), ('blendedLightCol', v407), ('blendedLightInt', 1), ('minShadow', v525), ('combWeight', v527), ('albScaled', v533), ('diffColor', v315), ('rampCol', v510), ('rampChroma', v512), ('rampChromaInv', v513), ('_CharacterParams6', v536), ('_CharacterParams6_w', v537), ('_CharacterParams7', v538), ('_CharacterParams7_w', v539), ('_CharacterParams1', v138), ('_CharacterParams1_w', v139), ('_CharacterParams12', v110), ('_CharacterParams12_w', v111), ('_CharacterParams0', v529), ('_CharacterParams0_w', v530)])
    v541 = g.math('MULTIPLY', v525, 0.5)
    v542 = g.math('ADD', v541, 0.5)
    v543 = g.math('MULTIPLY', v540[2], v542)
    v544 = g.bc(v543)
    v545 = g.vmath('MULTIPLY', v544, v540[1])
    v546 = g.group_named('RCE_BRDF_GGX_Stylized_Endfield', [('N', v252), ('V', v102), ('adjustedLightDir', v140[0]), ('camFwd', v109), ('roughness', v311)])
    v547 = g.inp('_FaceHighlightMap', False, 0.0)
    v548 = g.vmath('DOT_PRODUCT', v102, v206)
    v549 = g.inp('_HighlightMapVector', True, (0.04, -0.01, 0.0))
    v550 = g.inp('_HighlightMapVector_w', False, 0.0)
    v551 = g.sep(v549)
    v552 = g.math('MULTIPLY', v548, v551[0])
    v553 = g.vmath('DOT_PRODUCT', v102, v207)
    v554 = g.math('MULTIPLY', v553, v551[1])
    v555 = g.math('ADD', v154[0], v552)
    v556 = g.math('ADD', v154[1], v554)
    v557 = g.comb(v555, v556, 0.0)
    g.out_('F10_HighlightMap_uv', v557, True)
    v558 = g.inp('F10_HighlightMap', True, (0.0, 0.0, 0.0))
    v559 = g.inp('F10_HighlightMap_alpha', False, 1.0)
    v560 = g.mixv(v547, (0, 0, 0), v558)
    v561 = g.vmath('MULTIPLY', v540[1], v540[0])
    v562 = g.bc(v546[0])
    v563 = g.vmath('MULTIPLY', v323, v562)
    v564 = g.inp('_CharacterParams13', True, (0.0, 0.0, 0.0))
    v565 = g.inp('_CharacterParams13_w', False, 1.0)
    v566 = g.bc(v565)
    v567 = g.vmath('MULTIPLY', v563, v566)
    v568 = g.vmath('ADD', v567, v560)
    v569 = g.vmath('MULTIPLY', v545, v568)
    v570 = g.vmath('ADD', v561, v569)
    v571 = g.vmath('DOT_PRODUCT', v570, (0.2126729, 0.7151522, 0.072175))
    v572 = g.math('SUBTRACT', v571, 0.5)
    v573 = g.clampn(v572, 0, 0.5)
    v574 = g.inp('_CharacterParams9', True, (0.0, 1.0, 0.0))
    v575 = g.inp('_CharacterParams9_w', False, 0.4)
    v576 = g.group_named('RCE_ComputeSkinDir', [('camFwd', v109), ('_CharacterParams9', v574), ('_CharacterParams9_w', v575)])
    v577 = g.vmath('DOT_PRODUCT', v102, v485)
    v578 = g.group_named('RCE_ComputeSkinSmoothFalloff', [('NdotV', v577), ('_CharacterParams9', v574), ('_CharacterParams9_w', v575)])
    v579 = g.math('MULTIPLY', v269[2], v273)
    v580 = g.math('ABSOLUTE', v579, 0.0)
    v581 = g.math('SUBTRACT', v580, 0.9)
    v582 = g.math('MULTIPLY', v581, 10)
    v583 = g.clampn(v582)
    v584 = g.math('MULTIPLY', v583, v583)
    v585 = g.math('MULTIPLY', 2, v583)
    v586 = g.math('SUBTRACT', 3, v585)
    v587 = g.math('MULTIPLY', v584, v586)
    v588 = g.math('MULTIPLY', v575, 10)
    v589 = g.math('SUBTRACT', v588, 3)
    v590 = g.clampn(v589)
    v591 = g.vmath('DOT_PRODUCT', v109, v576[0])
    v592 = g.math('MULTIPLY', 0.01, -1.0)
    v593 = g.math('LESS_THAN', v591, v592)
    v594 = g.mixf(v593, 0, 1)
    v595 = g.math('MULTIPLY', v587, v578[0])
    v596 = g.math('MAXIMUM', v587, v594)
    v597 = g.math('MULTIPLY', v596, v259)
    v598 = g.mixf(v590, v595, v597)
    v599 = g.mixf(v255, v578[0], v598)
    v600 = g.vmath('DOT_PRODUCT', v254[0], v576[0])
    v601 = g.math('ADD', v600, 1)
    v602 = g.clampn(v601)
    v603 = g.math('MINIMUM', v100, v602)
    v604 = g.inp('_CharacterParams8', True, (0.0, 0.0, 0.0))
    v605 = g.inp('_CharacterParams8_w', False, 1.0)
    v606 = g.group_named('RCE_ComputeSkinSpec', [('skinDir', v576[0]), ('N', v485), ('diffColor', v315), ('skinShadow', v603), ('skinAmt', v599), ('_CharacterParams8', v604), ('_CharacterParams8_w', v605), ('_CharacterParams9', v574), ('_CharacterParams9_w', v575)])
    v607 = g.vmath('DOT_PRODUCT', v315, (0.2126729, 0.7151522, 0.072175))
    v608 = g.math('SUBTRACT', 1, v390[0])
    v609 = g.math('MULTIPLY', v608, v142)
    v610 = g.vmath('MULTIPLY', v407, (1, 1, 1))
    v611 = g.group_named('RCE_BRDF_SubsurfaceSpec_Endfield', [('N', v252), ('V', v102), ('adjXZ_x', v140[1]), ('adjXZ_z', v140[2]), ('adjXZLen', v140[3]), ('camLightFacing', v609), ('mask', v100), ('diffColorLum', v607), ('diffColor', v315), ('subsurfLight', v610)])
    v612 = g.inp('_CharacterParams15', True, (0.0, 0.0, 0.0))
    v613 = g.inp('_CharacterParams15_w', False, 0.0)
    v614 = g.sep(v612)
    v615 = g.math('MULTIPLY', 0.5, v614[2])
    v616 = g.math('SUBTRACT', 0.5, v615)
    v617 = g.clampn(v616, 0.001, 0.999)
    v618 = g.math('MULTIPLY', 2, v617)
    v619 = g.math('SUBTRACT', v618, 1)
    v620 = g.math('MAXIMUM', v619, 0)
    v621 = g.math('MULTIPLY', 2, v617)
    v622 = g.math('MINIMUM', v621, 1)
    v623 = g.math('MULTIPLY', v486, 0.5)
    v624 = g.math('SUBTRACT', v623, v620)
    v625 = g.math('SUBTRACT', v622, v620)
    v626 = g.math('DIVIDE', v624, v625)
    v627 = g.clampn(v626)
    v628 = g.math('MULTIPLY', v627, v627)
    v629 = g.math('MULTIPLY', 2, v627)
    v630 = g.math('SUBTRACT', 3, v629)
    v631 = g.math('MULTIPLY', v628, v630)
    v632 = g.math('CEIL', v615, 0.0)
    v633 = g.math('MULTIPLY', v632, v615)
    v634 = g.math('ADD', v631, v633)
    v635 = g.math('ABSOLUTE', v634, 0.0)
    v636 = g.math('MULTIPLY', v635, 2)
    v637 = g.math('SUBTRACT', v636, 0.5)
    v638 = g.clampn(v637)
    v639 = g.math('SUBTRACT', 1, v277[1])
    v640 = g.math('MULTIPLY', v638, v638)
    v641 = g.math('MULTIPLY', 2, v638)
    v642 = g.math('SUBTRACT', 3, v641)
    v643 = g.math('MULTIPLY', v640, v642)
    v644 = g.math('MULTIPLY', v639, v643)
    v645 = g.bc(v644)
    v646 = g.vmath('MULTIPLY', v315, v645)
    v647 = g.inp('_CharacterParams14', True, (0.0, 0.0, 0.0))
    v648 = g.inp('_CharacterParams14_w', False, 0.0)
    v649 = g.vmath('MULTIPLY', v646, v647)
    v650 = g.bc(v648)
    v651 = g.vmath('MULTIPLY', v649, v650)
    v652 = g.mixv(v255, (0, 0, 0), v651)
    v653 = g.math('MULTIPLY', v573, v573)
    v654 = g.math('ADD', v653, 1)
    v655 = g.bc(v571)
    v656 = g.vmath('SUBTRACT', v570, v655)
    v657 = g.bc(v654)
    v658 = g.vmath('MULTIPLY', v657, v656)
    v659 = g.bc(v571)
    v660 = g.vmath('ADD', v658, v659)
    v661 = g.vmath('ADD', v660, v606[0])
    v662 = g.vmath('ADD', v661, v611[0])
    v663 = g.vmath('ADD', v662, v652)
    v664 = g.inp('_EnableVFXColorAdjustment', False, 0.0)
    v665 = g.math('GREATER_THAN', v664, 0.5)
    v666 = g.inp('_ColorAdjustmentContrast', False, 1.0)
    v667 = g.inp('_ColorAdjustmentSaturation', False, 1.0)
    v668 = g.inp('_ColorAdjustmentRimWidth', False, 0.35)
    v669 = g.inp('_ColorAdjustmentBrightness', False, 1.0)
    v670 = g.inp('_ColorAdjustmentColorBlend', True, (1.0, 1.0, 1.0))
    v671 = g.inp('_ColorAdjustmentColorBlend_w', False, 0.0)
    v672 = g.inp('_ColorAdjustmentRimColor', True, (1.0, 1.0, 1.0))
    v673 = g.inp('_ColorAdjustmentRimColor_w', False, 1.0)
    v674 = g.inp('_ColorAdjustmentRimIntensity', False, 4.0)
    v675 = g.group_named('RCE_VFXColorAdjust', [('litColor', v663), ('NdotV', v292), ('rimMod', v286), ('_ColorAdjustmentContrast', v666), ('_ColorAdjustmentSaturation', v667), ('_ColorAdjustmentRimWidth', v668), ('_ColorAdjustmentBrightness', v669), ('_ColorAdjustmentColorBlend', v670), ('_ColorAdjustmentColorBlend_w', v671), ('_ColorAdjustmentRimColor', v672), ('_ColorAdjustmentRimColor_w', v673), ('_ColorAdjustmentRimIntensity', v674)])
    v676 = g.mixv(v665, v663, v675[0])
    v677 = g.sep(v114)
    v678 = g.bc(v677[0])
    ...
    g.out_('Z0_r___done', 0.0, False)
    g.out_('Z0_r_pixelLightCount', v680, False)
    v684 = g.inp('Z0_o_N', True)
    v685 = g.inp('Z0_o_Lloop0', False)
    v686 = g.inp('Z0_o_lightAccum', True)
    v687 = g.inp('Z0_o_lightIndex', False)
    v688 = g.inp('Z0_o_positionWS', True)
    v689 = g.vmath('ADD', v679, v686)
    v690 = g.sep(v679)
    v691 = g.sep(v689)
    v692 = g.comb(v691[0], v691[1], v691[2])
    g.out_('ret_gBuffer0', v692, True)
    g.out_('ret_gBuffer0_w', v83, False)
    g.out_('ret_gBuffer1', (0.0, 0.0, 0.0), True)
    g.out_('ret_gBuffer1_w', 0.0, False)
    g.out_('ret_gBuffer2', (0.0, 0.0, 0.0), True)
    g.out_('ret_gBuffer2_w', 0.0, False)
    g.out_('ret_color', v679, True)
