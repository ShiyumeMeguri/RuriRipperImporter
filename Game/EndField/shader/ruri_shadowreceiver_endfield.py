...
def build_Ruri_Endfield_ShadowReceiver():
    ...
    v13 = g.inp('Sun_Direction', True, (0.0247, -0.8220, 0.5690))
    v14 = g.b2u(v13)
    v15 = g.inp('Sun_Color', True, (1.0, 0.96, 0.9))
    v16 = g.inp('Sun_ShadowAtten', False, 1.0)
    v17 = g.math('SUBTRACT', 1, v16)
    v18 = g.math('SUBTRACT', 1, v17)
    v19 = g.inp('_DisableSceneShadow', False, 0.0)
    v20 = g.math('SUBTRACT', 1, v19)
    v21 = g.mixf(v20, 1, v18)
    v22 = g.math('SUBTRACT', 1, v21)
    v23 = g.math('SUBTRACT', 0.95, v22)
    v24 = g.clampn(v23)
    v25 = g.inp('_ShadowColor', True, (0.0, 0.0, 0.0))
    v26 = g.inp('_ShadowColor_w', False, 1.0)
    v27 = g.math('MULTIPLY', v24, v26)
    v28 = g.b2u(g.vtrans((0.0, 0.0, 0.0), 'OBJECT', 'WORLD', 'POINT'), point=True)
    v29 = g.inp('_CircleFade', False, 0.0)
    v30 = g.inp('_CircleFadeDistance', False, 1.0)
    v31 = g.inp('_CircleFadeSmoothness', False, 0.2)
    v32 = g.group_named('RCE_CircleFade', [('positionWS', v6), ('originWS', v28), ('enable', v29), ('distanceValue', v30), ('smoothness', v31)])
    v33 = g.math('MULTIPLY', v27, v32[0])
    v34 = g.mixv(v33, (1, 1, 1), v25)
    v35 = g.vmath('NORMALIZE', v7)
    v36 = g.inp('_UseAlphaTest', False, 0.0)
    v37 = g.inp('_AlphaClipThreshold', False, 0.5)
    v38 = g.math('SUBTRACT', v33, v37)
    v39 = g.math('LESS_THAN', v38, 0.0)
    v40 = g.math('SUBTRACT', 1.0, v39)
    v41 = g.math('MULTIPLY', 1.0, v40)
    v42 = g.mixf(v36, 1.0, v41)
    g.out_('ret_gBuffer0', v34, True)
    g.out_('ret_gBuffer0_w', v33, False)
    ...
    g.out_('ret_color', v34, True)
    g.out_('ret_color_w', v33, False)
